...
LIB_SOURCES =                                                   \
  ...
  enumerate/all_files_enumerator.cc                                 \
  enumerate/file_serializer.cc                                      \
  enumerate/picking_history_collector.cc                            \
  enumerate/request_info_collector.cc                               \
  enumerate/version_forest.cc			                                  \
  enumerate/enumerate_log.cc			                                      \
  enumerate/enumerate_option.cc                                         \
  port/mmap.cc                                                  \
  port/port_posix.cc                                            \
